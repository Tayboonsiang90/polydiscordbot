...
- White House Full Lid monitors Roll Call's Factba.se calendar and Forth's WH pool page for today's ET full lid; it also checks BNO News' White House Press Pool feed (`https://bnonews.com/whpool`) as a faster alpha source and skips lunch-lid reports. Alpha alerts must show the exact BNO/Forth source URL and keep alerting same-day alpha corrections until Roll Call confirms the official lid. It polls every minute during 8:00 AM-8:30 PM ET and hourly off-hours.
