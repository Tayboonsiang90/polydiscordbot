...
- Shared value-change alert UI lives in `src/embeds.ts`; keep the top of alerts human-first (`Quick read`, then compact snapshots) and push URLs/raw state into the shared `Links` field or lower-priority snapshot lines.
