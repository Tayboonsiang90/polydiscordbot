...
| `strategy-strc-market-cap` | `/monitor` | `#strcmarketcap` | `STRC Market Cap Alerts` | `📈` | Polls Strategy's official STRC Market Cap ($M) feed every 15 seconds and alerts once when a previously open Polymarket threshold is reached. |
