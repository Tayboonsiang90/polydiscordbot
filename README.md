...
| `silver-trump-approval` | `/monitor` | `#trumpapproval` | `Trump Approval Alerts` | `📊` | Monitors Silver Bulletin's Trump approval trend-line data, auto-discovers overlapping single-date and weekly Up/Down markets, alerts on finalized results, and tracks revisions to already-published target/reference approval rows. |
