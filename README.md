...
| `ethereum-gas-monthly-average` | `/monitor` | `#ethgasmonthly` | `ETH Gas Monthly Alerts` | `⛽` | Monitors Dune Ethereum Gas Prices query 1887488 for the latest finalized monthly `mean_gas` value and threshold context. |
