...
- Grouped UMA vote Show more details intentionally omit raw log hashes, raw token integers, and ancillary hex; they show readable request lines and latest request metadata instead.
