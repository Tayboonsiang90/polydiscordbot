...
| `polymarket-mention-schedule` | `/monitor` | `#mentions-schedule` | `Polymarket Mentions Schedule Alerts` | `🗓️` | Builds an hourly consolidated schedule of Mentions markets whose listed start time falls tomorrow in Singapore time, using rule timezones when shown and Polymarket card times as UTC fallback. |
