...
- Mention/video alerts lead with the new title and release time; MrBeast, Getty, AirNow, Mt. Washington, and NSIDC alerts lead with the decision-useful counter, threshold, coverage, wind, or extent value. Direct release/report/data-file URLs belong in the shared `Links` field.
