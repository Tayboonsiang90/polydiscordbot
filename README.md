...
| `pump-fun-buybacks` | `/monitor` | `#pumpbuybacks` | `Pump Buyback Alerts` | `💚` | Monitors the official Pump.fun Total $PUMP Purchases (USD) tracker hourly, sends one finalized daily update, and alerts immediately if cumulative buybacks cross $500M. |
