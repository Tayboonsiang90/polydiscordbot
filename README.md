...
| `noaa-seattle-precip` | `/monitor` | `#seattleprecip` | `NOAA Seattle Precip Alerts` | `☔` | Monitors NOAA Seattle monthly precipitation plus 1-minute KSEA hourly alpha; positive or trace hours alert while zero hours remain silent. |
