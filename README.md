...
- MrBeast views monitors the YouTube channel About metadata total view count, compares it to Gamma-parsed billion-view targets, uses `lastChangedAt` for rate math, and keeps `#mrbeastviews` as the canonical channel name.
